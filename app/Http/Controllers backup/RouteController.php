...
class RouteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $route = Route::create([
            'title'        => $request->title,
            'mapColor'     => $request->map_color,  // колонка в БД — mapColor
    ...
    public function storeOrUpdateInfo(Request $request, $routeId)
    {
        ...
        // Ищем существующую запись по route_id и label — обновляем или создаём
    ...
    private function transformRoute(Route $route)
    {
        return [
            'id'           => $route->id,
            'title'        => $route->title,
            'map_color'    => $route->mapColor,   // фронт всегда получает map_color
